...
# [START] setting up
echo "Starting at $(date +%T)" > /data/local/tmp/sysinitsupportlog.txt
echo "remounting system" >> /data/local/tmp/sysinitsupportlog.txt
...
# make init.d directory
echo "[*] Start init.d directory" >> /data/local/tmp/sysinitsupportlog.txt
